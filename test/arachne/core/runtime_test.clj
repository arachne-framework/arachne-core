...
(defn c1 [descriptor iri] {:this-is-c1 true})
(defn c2 [descriptor iri] {:this-is-c2 true})
(defn c3 [descriptor iri] {:this-is-c3 true})
(defn c4 [descriptor iri] {:this-is-c4 true})

(def basic-descriptor
  [{:rdf/about :test/rt
    :arachne.runtime/components {:arachne.component/constructor `c1}}])
...
(def linear-descriptor
  [{:rdf/about :test/rt
   ...
   {:rdf/about :test/c2
    :arachne.component/constructor 'arachne.core.runtime-test/c2
    :arachne.component/dependencies
...
(comment
  ...
  (def descriptor (a/descriptor :org.arachne-framework/arachne-core linear-descriptor))

  (clojure.pprint/pprint
    (rt/components descriptor :test/rt))
