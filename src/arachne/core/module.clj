(ns arachne.core.module
  ...
  (:require [clojure.edn :as edn]
            ...
            [arachne.core.descriptor.script :as script]
    ...
    (d/with-provenance `initialize
      (doseq [[m i] initializers]
        ...
        (cond
          ...
          :else (throw (ex-info "Value of :arachne.module/inits is inot a valid type for an initializer."
                                {:initializer i}))))))
  d)
